...
$body = '<p>Количество остановок: <strong>' . $count . '</strong></p>' .
  '<p>Тип лифта: <strong>' . $lifttype . '</strong></p>' .
  '<p>Общая высота подъёма, м: <strong>' . $height . '</strong></p>' .
  '<p>Вид двери: <strong>' . $door . '</strong></p>' .
  '<p>Размер кабины: <strong>' . $size . '</strong></p>' .
  '<p>Способ связи: <strong>' . $call . '</strong></p>' .
